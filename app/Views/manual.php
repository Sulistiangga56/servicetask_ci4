...
<div class="container">
		<h2 style=" width: 100%; border-bottom: 4px solid #FF8C00"><b>Penggunaan Aplikasi</b></h2>
	<div class="bs-acc">
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading" style="background-color: #eee;">
					<h4 class="panel-title">
						Bagaimana Cara Memakai Jasa di Service Task ?
					</h4>
				</div>
				</a>
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="panel-body">
						<ol>
							...
							<li>Pilih Jasa Produk yang ingin digunakan</li>
